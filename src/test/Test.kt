...
object Test {
    ...
    fun romanInteger(s: String?) {
        val res = RomanInteger().romanToInt(s)
        println("result: $res")
    }

    fun longestCommonPrefix() {
        val res = LongestCommonPrefix().longestCommonPrefix2(lcpd)
        println("result: $res")
    }

    fun sum() {
        val res = Sum().threeSum2(sumd)
        println("result: $res")
    }

    fun addTwoNumbers() {
        val l13 = ListNode(3)
        val l12 = ListNode(4, l13)
        val l1 = ListNode(2, l12)
        val l23 = ListNode(4)
        val l22 = ListNode(6, l23)
        val l2 = ListNode(5, l22)
        //        AddTwoNumbers.print(l1);
//        AddTwoNumbers.print(l2);
        val res = AddTwoNumbers().addTwoNumbers(l1, l2)
    ...
    fun longestSubstring() {
        ...
        val t = "pwwkew"
        val l = "tmmzuxt"
        println(LongestSubstring().lengthOfLongestSubstring3(t))
    }
    ...
    fun longestPalindromicSubstring() {
        ...
        println(LongestPalindromicSubstring().longestPalindrome(s))
    }

    fun zigzagConversion() {
        val s = "ABCDEFGHIJKLMNOPQR"
        println(ZigzagConversion().convert(s, 5))
    }

    fun shuffleTheArray() {
        val nums = intArrayOf(1, 2, 3, 4, 4, 3, 2, 1)
        println(Arrays.toString(ShuffleTheArray().shuffle(nums, 4)))
    }
    ...
    fun stringToInteger() {
        val s = "   -234523sadf"
        val s2 = "00000-42a1234"
        val s3 = "-13+8"
        val s4 = "123-"
        val s5 = "+-12"
        println(StringToInteger().myAtoi(s3))
    }

    fun palindromeNumber() {
        val x = 121
        println(PalindromeNumber().isPalindrome2(x))
    }
    ...
    fun addToArrayFormOfInteger() {
        val num = intArrayOf(9, 9, 9, 9, 9, 9, 9, 9, 9, 9)
        val k = 1
        println(AddToArrayFormInteger().addToArrayForm2(num, k))
    }

    fun maxDepthOfBianryTree() {
        val root = TreeNode(3)
        ...
        println(MaxDepthOfBinaryTree().maxDepth2(root2))
    }
    ...
    fun regularExpressionMatching() {
        ...
        val s1 = "aaa"
        val p1 = "a*a"
        println(ExpressionMatching().isMatch(s1, p1))
    }
    ...
    fun containerWithMostWater() {
        ...
        println(ContainerWithMostWater().maxArea1(height))
    }

    fun sumClosest() {
        val nums = intArrayOf(4, 0, 5, -5, 3, 3, 0, -4, -5)
        println(SumClosest().threeSumClosest(nums, -2))
    }

    fun sltoBst() {
        val l5 = ListNode(9)
        val l4 = ListNode(5, l5)
        val l3 = ListNode(0, l4)
        val l2 = ListNode(-3, l3)
        val l1 = ListNode(-10, l2)
        SLToBST().sortedListToBST(l1)
    }

    fun symmetricTree() {
        val t1 = TreeNode(3)
        val t2 = TreeNode(2, null, t1)
        val t3 = TreeNode(3)
        val t4 = TreeNode(2, null, t3)
        val t5 = TreeNode(1, t2, t4)
        val t6 = TreeNode(3)
        val t7 = TreeNode(4)
        val t8 = TreeNode(2, t6, t7)
        val t9 = TreeNode(4)
        val t10 = TreeNode(3)
        val t11 = TreeNode(2, t9, t10)
        val t12 = TreeNode(1, t8, t11)
        val t13 = TreeNode(2)
        val t14 = TreeNode(3)
        val t15 = TreeNode(1, t13, t14)
        println(SymmetricTree().isSymmetric(t5))
    }

    fun sumRootToLeafNumbers() {
        val t1 = TreeNode(5)
        val t2 = TreeNode(1)
        val t3 = TreeNode(9, t1, t2)
        val t4 = TreeNode(0)
        val t5 = TreeNode(4, t3, t4)
        val t6 = TreeNode(5)
        val t7 = TreeNode(1, null, t6)
        println(SumRootToLeafNumbers().sumNumbers(t5))
    }
    ...
    fun trie() {
        ...
        trie.insert("spread")
        trie.insert("spade")
        println("haha: " + trie.search("haha"))
        println("sprea: " + trie.search("sprea"))
        println("spread: " + trie.search("spread"))
        println("sprea start: " + trie.startsWith("sprea"))
    }
...
//        wd.addWord("mad");
        ...
        wd.addWord("add")
        wd.search("a")
        println(wd.search(".at"))
        wd.addWord("bat")
        println(wd.search(".at"))
        println("bad: " + wd.search("bad"))
        println("b.d: " + wd.search("b.d"))
    }

    fun canPlaceFlowers() {
        val flowerbed = intArrayOf(1, 0, 0, 0, 1)
        val flowerbed2 = intArrayOf(0, 0, 1, 0, 1)
        val flowerbed3 = intArrayOf(1)
        val flowerbed4 = intArrayOf(0, 0, 0)
        println(CanPlaceFlowers().canPlaceFlowers(flowerbed4, 2))
    }
    ...
    fun mimimunScore() {
        ...
        println(MinimumScoreOfAPathBTC().minScore(n2, roads2))
    }
    ...
    fun connectNetwork() {
        ...
        println(ConnectNetwork().makeConnected(n, connections))
    }

    fun unreachableNodes() {
//        var s = BigInteger("0")
//        val a = BigInteger("50000")
//        s += a.multiply(a)
//        println("s: $s")
...
//    fun testMyThread(){
//        val t1 = PrintThread(1)
//        val t2 = PrintThread(2)
//        val t3 = PrintThread(3)
//        t1.start()
//        t2.start()
//        t3.start()
//    }
    ...
    fun differenceOfTwoArrays() {
        val nums1 = intArrayOf(1, 2, 3)
        val nums2 = intArrayOf(2, 4, 6)
        println(DifferenceOfTwoArrays().findDifference(nums1, nums2))
    }
    ...
    fun spiralMatrix() {
        ...
        SpiralMatrix().spiralOrder(matrix2).forEach {
            print("$it ")
        }
    }
    ...
    fun reverseList() {
        ...
        ListNode.printList(ReverseList().reverseList(node1))
    }
